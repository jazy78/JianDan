...
/** 
 * DAO for table JOKE_CACHE.
*/
public class JokeCacheDao extends AbstractDao<JokeCache, Long> {
    ...
    */
    ...
    public JokeCacheDao(DaoConfig config) {
        super(config);
    }
    
    public JokeCacheDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'JOKE_CACHE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'JOKE_CACHE'";
        db.execSQL(sql);
    }
