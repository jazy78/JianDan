...
/** 
 * DAO for table FRESH_NEWS_CACHE.
*/
public class FreshNewsCacheDao extends AbstractDao<FreshNewsCache, Long> {

    public static final String TABLENAME = "FRESH_NEWS_CACHE";

    /**
     * Properties of entity FreshNewsCache.<br/>
    ...
    */
    ...
    public FreshNewsCacheDao(DaoConfig config) {
        super(config);
    }
    
    public FreshNewsCacheDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'FRESH_NEWS_CACHE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'FRESH_NEWS_CACHE'";
        db.execSQL(sql);
    }
    ...
    /** @inheritdoc */
    @Override
    public FreshNewsCache readEntity(Cursor cursor, int offset) {
        FreshNewsCache entity = new FreshNewsCache( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FreshNewsCache entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(FreshNewsCache entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(FreshNewsCache entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
