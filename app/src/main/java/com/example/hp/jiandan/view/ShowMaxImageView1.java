 ...
 */
public class ShowMaxImageView1 extends ImageView {

	private float mHeight = 0;

	public ShowMaxImageView1(Context context) {
		super(context);
	}

	public ShowMaxImageView1(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public ShowMaxImageView1(Context context, AttributeSet attrs, int defStyleAttr) {
