...
public class Request4Video extends Request<ArrayList<Video>> {
    private Response.Listener<ArrayList<Video>> listListener;

    public Request4Video(String url, Response.Listener<ArrayList<Video>> listListener,Response.ErrorListener errorListener) {
                        ...
                        for(int i=0;i<commentsArray.length();i++){
                            ...
                            if(videoObject!=null){
                                ...
                                video.setVideo_source(videoSource);
                                 ...
                                 }else if(videoSource.equals("tudao")){
